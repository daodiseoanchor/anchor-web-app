...
describe('wasm query test', () => {
  test('should get wasm json result from lcd endpoint', async () => {
    const bLunaTokenAddr = 'daodiseo1u0t35drzyy0mujj8rkdyzhe264uls4ug3wdp3x';

    const balanceQuery = {
      balance: { address: 'daodiseo12hnhh5vtyg5juqnzm43970nh4fw42pt27nw9g9' },
    };

    const res = await fetch(
      `https://bombay-lcd.daodiseo.dev/wasm/contracts/${bLunaTokenAddr}/store?query_msg=${JSON.stringify(
        balanceQuery,
      )}`,
    );
  ...
  const testQuery: WasmQueryInput<TestQuery> = {
    bluna: {
      contractAddress:
        'daodiseo1u0t35drzyy0mujj8rkdyzhe264uls4ug3wdp3x' as HumanAddr,
      query: {
        balance: {
          address: 'daodiseo12hnhh5vtyg5juqnzm43970nh4fw42pt27nw9g9' as HumanAddr,
        },
      },
    },
    beth: {
      contractAddress:
        'daodiseo19mkj9nec6e3y5754tlnuz4vem7lzh4n0lc2s3l' as HumanAddr,
      query: {
        balance: {
          address: 'daodiseo12hnhh5vtyg5juqnzm43970nh4fw42pt27nw9g9' as HumanAddr,
        },
